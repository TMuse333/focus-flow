...
reverse,activated }) => {
    ...
    return (
            ...
            <motion.h2
            ref={targetRef}
                className="block text-center md:text-start  font-semibold bg-gradient-to-b from-white to-gray-300 bg-clip-text text-transparent text-3xl md:text-5xl mb-8 md:pl-8 pb-4"
